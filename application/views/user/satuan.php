...
<style>
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-outline card-danger">
            <?php if ($jsatuan == 0) { ?>
                <div class="card-header card-uploadsatuan">
                  <form id="uploadsatuan-form" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header">
              <h6 style="margin-top:5px" class="card-title " text-align="center"><strong>DAFTAR SATUAN</strong></h6>
              <a class="btn btn-sm btn-outline-info float-right btn_tambah_satuan"><i class="fas fa-plus"></i>&ensp;Tambah Data</a>
              <br>
            ...
            <div class="card-body">
              ...
              <div class="input-group ">
                <input class="form-control col-sm-12" name="searchsatuan" id="searchsatuan" type="text" placeholder="Search" aria-label="Search">
                <div class="input-group-append">
                  <button class="btn btn-primary searchButtonsatuan">
              ...
              <table id="satuanData" class="table table-striped" style="width:100%;margin-top:5px;">
                <thead>
                  <tr>
    ...
    <!-- Modal -->
      <div class="modal fade" id="satuanModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form id="satuanForm" enctype="multipart/form-data">
              <div class="form-group">
                <div class="row">
                  <div class="col-md-4">  
