...
class Admin extends CI_Controller {
	...
	public function saveupdatebarang(){
    // Pastikan user adalah admin
	    if ($this->session->userdata('level') == 'Admin') {
	        // Mendapatkan data user
	        $data['user'] = $this->db->get_where('tb_users', ['username' => $this->session->userdata('username')])->row();
	        ...
	        header('Content-Type: application/json');
	                ...
	                $response = [
	                    'status' => 'success',
	                    'message' => 'Rekening Berhasil Di pilih.'
	                ];
	...
	public function saveupdatebarangb(){
    // Pastikan user adalah admin
	    if ($this->session->userdata('level') == 'Admin') {
	        // Mendapatkan data user
	        $data['user'] = $this->db->get_where('tb_users', ['username' => $this->session->userdata('username')])->row();
	        ...
	        header('Content-Type: application/json');
	                ...
	                $response = [
	                    'status' => 'success',
	                    'message' => 'Kategori Berhasil Di pilih.'
	                ];
	...
	public function saveupdaterekeningc(){
	    if ($this->session->userdata('level') == 'Admin') {
	...
	public function saveupdatekategoric(){
	    if ($this->session->userdata('level') == 'Admin') {
...
/*-- user --*/
	...
	/*-- kelompok barang --*/
	public function kelompok_barang(){
		$data['user'] = $this->db->get_where('tb_users',['username' => $this->session->userdata('username')])->row();
		$data['parent'] = "Data Kelompok Barang";
		$data['page'] = "List Data Kelompok Barang";
		$this->template->load('admin/layout/admin_template','admin/kelompok_barang',$data);
	}
    ...
    if (($this->session->userdata('logged_in') != "" && $this->session->userdata('stts') == "Admin_Berkah") || ($this->session->userdata('logged_in') != "" && $this->session->userdata('stts') == "Operator_Berkah")) {
