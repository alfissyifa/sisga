...
<style>
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-outline card-danger">
            <?php if ($jbarang == 0) { ?>
                <div class="card-header card-uploadbarang">
                  <form id="uploadbarang-form" method="post" enctype="multipart/form-data">
            ...
            <div class="card-header">
              <h6 style="margin-top:5px" class="card-title " text-align="center"><strong>DAFTAR KODE KELOMPOK BARANG</strong></h6>
              <a class="btn btn-sm btn-outline-info float-right btn_tambah_barang"><i class="fas fa-plus"></i>&ensp;Tambah Data</a>
              <br>
            ...
            <div class="card-body">
              ...
              <div class="input-group ">
                <input class="form-control col-sm-12" name="searchbarang" id="searchbarang" type="text" placeholder="Search" aria-label="Search">
                <div class="input-group-append">
                  <button class="btn btn-primary searchButtonbarang">
              ...
              <table id="barangData" class="table table-striped" style="width:100%;margin-top:5px;">
                <thead>
                  <tr>
    ...
    <!-- Modal -->
      <div class="modal fade" id="barangModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          ...
          <div class="modal-body">
            ...
            <form id="barangForm" enctype="multipart/form-data">
              <div class="form-group">
                <div class="row">
                    <div class="col-md-6">  
                      <label class="col-form-label">KODE KELOMPOK BARANG</label>
                    </div>
                    <div class="col-md-6">  
                        <input type="hidden" class="form-control" id="kode_brg_a" name="kode_brg_a" readonly>
                        <input type="text" name="kode_brg" class="form-control" id="kode_brg" required>
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-6">  
                      <label class="col-form-label">URAIAN KELOMPOK BARANG</label>
                    </div>
                    <div class="col-md-6">  
                        <textarea style="height: 150px;" type="text" name="nama_brg" class="form-control" id="nama_brg"></textarea>
                    </div>
                </div>
              </div>
